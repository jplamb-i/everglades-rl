...
def RequestGroups(pubsocket, guid):
    ...
    Units.append(1)
    Nums.append(100)
    #evgcom.PY_GROUP_InitGroup(pubsocket, guid, Units, Nums, "attackers")
...
#     Nums0.append(10)
#     Nums0.append(10)
#     evgcom.PY_GROUP_InitGroup(pubsocket, guid, Units0, Nums0, "one")
...
#     Nums1.append(20)
#     Nums1.append(10)
#     evgcom.PY_GROUP_InitGroup(pubsocket, guid, Units1, Nums1, "two")
...
#     Nums2.append(20)
#     Nums2.append(10)
#     evgcom.PY_GROUP_InitGroup(pubsocket, guid, Units2, Nums2, "three")
    
#     Units3 = []
#     Nums3 = []
#     Units3.append("Controller")
#     Nums3.append(10)
#     evgcom.PY_GROUP_InitGroup(pubsocket, guid, Units3, Nums3, "four")
...
def check_message(record_type, json_data, pubsocket, time_stamp):
    if (evg.TurnStart.TypeId() == record_type):
        ...
        print("Combat update BE AGGRESSIVE!")
...
def program_main(): 
    ...
    evgcom.HelloWorld(pubsocket, guidstrP0, "aggressive")
    waiting = True
    while waiting:
        # Read envelope with address
        try:
